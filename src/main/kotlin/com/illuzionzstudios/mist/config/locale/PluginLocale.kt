...
abstract class PluginLocale(
    ...
    companion object {
         ...
         */
        var COMMAND_LABEL_OPTIONAL_ARGS = STARTUP_GROUP.create("command.label-optional-args", "optional arguments")
         ...
         */
        var INTERFACE_CONFIRM_CONFIRM_NAME = STARTUP_GROUP.create("interface.confirm.confirm.name", "&a&lConfirm")
         ...
         */
        var INTERFACE_CONFIRM_DENY_NAME = STARTUP_GROUP.create("interface.confirm.deny.name", "&c&lDeny")

        /**
         * Lore of the deny icon in the confirm inventory
         */
        var INTERFACE_CONFIRM_DENY_LORE = STARTUP_GROUP.create("interface.confirm.deny.lore", "&7&o(Click to deny)")

        /**
         * The message if a new version is found
         */
        var UPDATE_AVAILABLE = STARTUP_GROUP.create(
            "update.available", """
